...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    #add test code here
    cube_test = volume_of_cube(5)
    self.assertEqual(125, cube_test)
    # pass

  #Given a String, return the String reversed
  
  def test_reverse_string(self):
    test_string = reverse_string("hello")
  ...
  def test_fahrenheit_to_celsius(self):
    #add test code here
    test_fahrenheit = fahrenheit_to_celcius(150)
    self.assertEqual(65.55555555555556,test_fahrenheit )
    # pass
